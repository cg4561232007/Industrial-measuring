...
QT_MOC_LITERAL(1, 8, 14), // "sendhandledata"
QT_MOC_LITERAL(2, 23, 0), // ""
QT_MOC_LITERAL(3, 24, 4), // "stop"
QT_MOC_LITERAL(4, 29, 11), // "threadpause"
QT_MOC_LITERAL(5, 41, 12) // "threadresume"

    },
    "mthread\0sendhandledata\0\0stop\0threadpause\0"
    "threadresume"
};
...
void mthread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sendhandledata(); break;
        ...
        {
            typedef void (mthread::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&mthread::sendhandledata)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject mthread::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_mthread.data,
      qt_meta_data_mthread,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
