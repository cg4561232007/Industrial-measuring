...
QT_MOC_LITERAL(1, 8, 11), // "pixmapReady"
QT_MOC_LITERAL(2, 20, 0), // ""
QT_MOC_LITERAL(3, 21, 9), // "setXYcord"
QT_MOC_LITERAL(4, 31, 8), // "showGrid"
QT_MOC_LITERAL(5, 40, 10), // "paintEvent"
QT_MOC_LITERAL(6, 51, 12), // "QPaintEvent*"
QT_MOC_LITERAL(7, 64, 3), // "qev"
QT_MOC_LITERAL(8, 68, 10) // "testwidget"

    },
    "mwidget\0pixmapReady\0\0setXYcord\0showGrid\0"
    "paintEvent\0QPaintEvent*\0qev\0testwidget"
};
...
void mwidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        mwidget *_t = static_cast<mwidget *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->pixmapReady(); break;
        case 1: _t->setXYcord(); break;
        case 2: _t->showGrid(); break;
        case 3: _t->paintEvent((*reinterpret_cast< QPaintEvent*(*)>(_a[1]))); break;
        case 4: _t->testwidget(); break;
        default: ;
        }
        ...
        {
            typedef void (mwidget::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&mwidget::pixmapReady)) {
                *result = 0;
            }
        }
    }
