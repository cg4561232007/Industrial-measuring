...
QT_MOC_LITERAL(1, 8, 8), // "transpal"
QT_MOC_LITERAL(2, 17, 0), // ""
QT_MOC_LITERAL(3, 18, 22), // "QMap<QString,QString>&"
QT_MOC_LITERAL(4, 41, 11), // "loadSetting"
QT_MOC_LITERAL(5, 53, 6) // "ensure"

    },
    "setting\0transpal\0\0QMap<QString,QString>&\0"
    "loadSetting\0ensure"
};
...
void setting::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->transpal((*reinterpret_cast< QMap<QString,QString>(*)>(_a[1]))); break;
        case 1: _t->loadSetting(); break;
        case 2: _t->ensure(); break;
        default: ;
        }
        ...
        {
            typedef void (setting::*_t)(QMap<QString,QString> & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&setting::transpal)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void setting::transpal(QMap<QString,QString> & _t1)
{
